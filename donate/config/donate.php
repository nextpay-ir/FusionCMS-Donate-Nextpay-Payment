...
$config['donation_currency'] = ""; // Remember to change the currency ON Nextpay as well!
$config['donation_currency_sign'] = " تومان";

/*
|--------------------------------------------------------------------------
| NextPay Donate System
|--------------------------------------------------------------------------
*/

$config['donate_nextpay'] = array(
	'use' => true, // true: enable | false: disable
	'postback_url' => "http://domain.ir/donate/nextpayreturnback",
	'ApiKey' => '00000000-0000-0000-0000-000000000000', // NextPay Api Key
	'values' => array(
